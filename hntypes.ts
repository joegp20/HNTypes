...
export enum HNDocumentType {
  HOME_INSPECTION = 1,
  WOOD_DESTROYING_ORGANISM_INSPECTION = 2,
  ROOF_INSPECTION = 3,
  SEWER_INSPECTION = 4,
  WELL_INSPECTION = 5,
  SEPTIC_INSPECTION = 6,
  POOL_INSPECTION = 7,
  AIR_QUALITY_INSPECTION = 8,
  CHIMNEY_INSPECTION = 9,
  OTHER_INSPECTION = 10,
  OFFER = 11,
  LISTING_AGREEMENT = 12,
  UNKNOWN_DOCUMENT = 13
}
 ...
 *
 *  status === "processing"
 *    – No analysis yet. A background task has been scheduled.
 *    – `analysis`, `cached`, `persisted` are all omitted.
 *    – Caller should either poll again later, or wait for the realtime
 *      OFFERS-row-updated event and re-read the offer.
 *    – HTTP status will be 202 on this path.
 */
