 ...
 *
 *  - `cached: true`  → analysis was already present on the offer and
 *                      returned as-is. `persisted` is omitted.
 *  - `cached: false` → analysis was just generated by the LLM.
 *                      `persisted` indicates whether the DB updated with the new analysis successfully or not.
 */
